                                ...
                                <form action="{{ route('admin.kelola-obat.save') }}" method="POST">
                                    ...
                                    <div class="mb-4">
                                        ...
                                        <input type="text" id="nama_obat" name="nama_obat"
                                            class="mt-2 px-4 py-2 w-full border rounded-lg" required placeholder="Nama Obat">
                                    </div>
                                    <div class="mb-4">
                                        <label for="kemasan"
                                            class="block text-gray-800 dark:text-neutral-400">Kemasan</label>
                                        <textarea id="kemasan" name="kemasan" class="mt-2 px-4 py-2 w-full border rounded-lg" rows="4" placeholder="Kemasan"></textarea>
                                    </div>
                                    <div class="mb-4">
                                        <label for="harga"
                                            class="block text-gray-800 dark:text-neutral-400">Harga</label>
                                            <input type="number" id="harga" name="harga"
                                            class="mt-2 px-4 py-2 w-full border rounded-lg" required placeholder="Harga">
                                    </div>
                                    <div
